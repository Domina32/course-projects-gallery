...
{
    public class IsNotEqual : BinarOp
    {
        public IsNotEqual(Expression left, Expression right) //prenese 2 podcvora - lijevi i desni operand
            : this(left, right, null)
        { }

        public IsNotEqual(Expression left, Expression right, Coordinate coord)
