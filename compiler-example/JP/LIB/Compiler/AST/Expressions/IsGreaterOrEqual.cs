...
{
    public class IsGreaterOrEqual : BinarOp
    {
        public IsGreaterOrEqual(Expression left, Expression right) //prenese 2 podcvora - lijevi i desni operand
            : this(left, right, null)
        { }

        public IsGreaterOrEqual(Expression left, Expression right, Coordinate coord)
