...
{
    public class IsLessOrEqual : BinarOp
    {
        public IsLessOrEqual(Expression left, Expression right) //prenese 2 podcvora - lijevi i desni operand
            : this(left, right, null)
        { }

        public IsLessOrEqual(Expression left, Expression right, Coordinate coord)
