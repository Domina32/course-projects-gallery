...
{
    public class IsLess : BinarOp
    {
        public IsLess(Expression left, Expression right) //prenese 2 podcvora - lijevi i desni operand
            : this(left, right, null)
        { }

        public IsLess(Expression left, Expression right, Coordinate coord)
