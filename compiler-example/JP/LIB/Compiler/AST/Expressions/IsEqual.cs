...
{
    public class IsEqual : BinarOp
    {
        public IsEqual(Expression left, Expression right) //prenese 2 podcvora - lijevi i desni operand
            : this(left, right, null)
        { }

        public IsEqual(Expression left, Expression right, Coordinate coord)
