...
{
    public class Add : BinarOp //nasljeduje klasu binarna operacija
    {
        public Add(Expression left, Expression right) //prenese 2 podcvora - lijevi i desni operand
            :this(left, right, null)
        { }

        public Add(Expression left, Expression right, Coordinate coord)
